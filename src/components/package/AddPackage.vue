  ...
  <v-container>
    ...
    >
      ...
      <template v-slot:[`item.per_week`]="{ item}">
        <v-chip v-if="item.per_week" color="green" dark>
      ...
      <template v-slot:[`item.updated_at`]="{ item }">
        <v-row>
          ...
          <v-icon :x-small="true" class="ml-1" color="primary">
            mdi-clock-edit
          </v-icon>
        </v-row>
      </template>
      <template v-slot:[`item.created_at`]="{ item }">
        <v-row>
          ...
          <v-icon :x-small="true" class="ml-1" color="success">
            mdi-clock-check
          </v-icon>
        </v-row>
      </template>
      <template v-slot:[`item.action`]="{ item }">
        <v-icon class="mr-2" color="green" small @click="OpenModalEdit(item)">
          mdi-pencil
        </v-icon>
