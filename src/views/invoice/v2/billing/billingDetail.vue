...
<!--              </v-btn>-->
              ...
              <v-btn class="btn btn-primary mr-4 elevation-0" v-if="invoice.status === 'to_confirm_payment'" @click="toConfirm(invoice.id)">
                ປະຕິເສດການຊຳລະ
              </v-btn>
          ...
          <v-card-actions class="mt-6">
            <v-spacer></v-spacer>
            <v-btn color="info"  :loading="loading" :disabled="loading" @click="Download(invoice)"  class="white--text px-12 btn-primary elevation-0"
