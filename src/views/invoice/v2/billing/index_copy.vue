...
<!--          </v-text-field>-->
      ...
      <v-card-text>
        ...
        <v-simple-table   v-model="selectedRows"
                          show-select>
          <template v-slot:default>
            <thead>
            <tr>
              <!--              <th class="text-left">#</th>-->
              <th class="text-left">ເລກບິນ</th>
...
<!--              <th class="text-left">Collection Image</th>-->
            ...
            <tr v-for="(data, index) in collections" :key="index">
              ...
              <td>
                <div v-if="data.user">{{ data.user.phone }}</div>
              </td>
              <!--              <td>{{ user.village.name }}</td>-->
              <!--              <td>{{ Intl.NumberFormat().format(data.billing.discount )}}</td>-->
              <td>{{Intl.NumberFormat().format( data.sub_total) }}</td>
              <td>{{ Intl.NumberFormat().format(data.total )}}</td>
              <td>
                <v-chip label color="primary">{{collectStatus(data.status)}}</v-chip>
              </td>
              <td>
