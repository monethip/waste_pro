<template>
  <v-container>
    <v-row>
      ...
      <v-col>
        <p class="text-caption">ວັນທີເພີ່ມຂໍ້ມູນ</p>
        <v-row name="date">
          <v-col>
            <v-menu
                v-model="start_menu"
                    ...
                    <v-menu offset-y>
                      ...
                      <v-list>
                        <v-list-item link @click="addPackage(item.id)">
                          <v-list-item-title>
                            <v-icon class="mr-2" small>mdi-plus
                            </v-icon
                            >
                            ເພີ່ມປະເພດບໍລິການ
                          </v-list-item-title>
                        ...
                        <v-list-item link @click="openChangePackage(item)">
                          <v-list-item-title>
                            <v-icon class="mr-2" small>mdi-pencil
                            </v-icon
                            >
                            ປ່ຽນປະເພດບໍລິການ
                          </v-list-item-title>
    ...
    <v-dialog v-model="importFile" persistent width="720">
      <template>
        <v-card>
          <v-card-title>
            <p>Import Customer</p>
          ...
          <v-card-text>
            <v-form ref="form" lazy-validation>
              ...
              <div v-if="!errors.length == 0">
                <p v-for="(error, index) in errors" :key="index" class="errors">
                  {{ error }}
                </p>
              </div>
