            ...
            <v-col>
                <v-card class="pa-2">
                    <v-card-title class="my-auto">
                        ...
                        <v-row>
                            <v-col>
                                <v-text-field v-model="search" clearable prepend-inner-icon="mdi-magnify" label="Search"
                                    single-line hide-details @keyup.enter="Search()" outlined dense></v-text-field>
                            </v-col>

                            <v-col>
                                <v-text-field v-model="searchPhone" clearable prepend-inner-icon="mdi-magnify"
                                    label="Phone" type="number" class="input-number" single-line hide-details
                                    @keyup.enter="SearchPhone()" outlined dense></v-text-field>
                            </v-col>
                        </v-row>
                    </v-card-title>
                    <v-data-table :headers="headers" :items="users" :search="search" :disable-pagination="true"
                        ...
                        <template v-slot:item.status="{ item }">
                            <v-chip label small class="mr-2" @click="changeStatus(item)"
                        ...
                        <template v-slot:item.actions="{ item }">
                            <v-menu offset-y>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon color="primary" dark v-bind="attrs" v-on="on" medium class="mr-2">
                        ...
                        <v-container>
                            <v-form ref="form" lazy-validation>
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        <v-text-field label="ເບີໂທ *" required v-model="user.phone" :rules="phoneRules"
                                            type="number" class="input-number">
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="12">
                                        <v-text-field label="Email" required v-model="user.email" :rules="emailRule">
                                        </v-text-field>
                                        <p class="errors">
                                            {{ server_errors.email }}
                                        </p>
                                    ...
                                    <v-col cols="12">
                                        <v-text-field label="Password Confirm" type="password" required
                                            v-model="user.password" :rules="passwordRules" autocomplete="">
                                        </v-text-field>
                                        <p class="errors">
                                    ...
                                    <v-col cols="12">
                                        <v-text-field label="Password" type="password" required
                                            v-model="user.password_confirmation" :rules="passwordRules" autocomplete="">
                                        </v-text-field>
                                        <p class="errors">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-form ref="form" lazy-validation>
                                <v-row>
                                    <v-col cols="12">
                                        <v-text-field label="Name *" required v-model="edit_user.name"
                                    ...
                                    <v-col cols="12">
                                        <v-text-field label="ເບີໂທ *" required v-model="edit_user.phone"
                                            :rules="phoneRules" type="number" class="input-number" disabled>
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="12">
                                        <v-text-field label="Email" required v-model="edit_user.email"
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="blue darken-1" text :loading="loading" :disabled="loading"
                                @click="updateItem()">
                                Update
                            </v-btn>
                        </v-card-actions>
                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-text-field label="Password Confirm *" type="password" v-model="password_confirm"
                                        :rules="passwordConfirmRules" required @keyup.enter="resetPasswordAction">
                                    </v-text-field>
                                    <p class="errors">
                                        {{ server_errors.password_confirmation }}
                                    </p>
                ...
                <v-card-text>
                    <v-container>
                        <v-form ref="form" lazy-validation>
                            <v-row>
                                <v-col cols="12">
                                    <v-select label="Status *" :items="statuses" v-model="edit_user.status"
                                        item-text="name" item-value="name" required></v-select>
                                    <p class="errors">
        ...
        <ModalDelete>
            <template>
                <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" text :loading="loading" :disabled="loading" @click="deleteItemConfirm">
                        OK</v-btn>
                    <v-spacer></v-spacer>
                </v-card-actions>
            </template>
