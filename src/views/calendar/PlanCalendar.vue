        ...
        <v-card-text>
          ...
          >
            ...
            <template v-slot:item.date="{ item }">
              <v-chip :color="getStatus(item.is_cancelled)">
                {{ item.date }}
              </v-chip>
            </template>
                ...
                <v-row>
                  <v-col cols="12">
                    ...
                    >
                      ...
                      <v-date-picker v-model="calendarEdit.date" />
                    </v-menu>
                    <p class="errors">
                      {{ server_errors.date }}
                    </p>
