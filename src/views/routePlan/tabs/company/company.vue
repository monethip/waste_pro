  ...
  <v-container>
    <v-row>
      <v-col>
        ...
        <v-btn class="btn-primary mr-6" @click="exportCompany()">
          ...
          >
            ...
            <template v-slot:item.sum_expect_trash_container="{ item }">
              <v-chip
                outlined
                color="blue"
              >{{ Intl.NumberFormat().format(item.sum_expect_trash_container) }}</v-chip>
            </template>
            <template v-slot:item.actions="{ item }">
              <!--                <v-btn color="lighten-2" text @click="viewPage(item.id)">&ndash;&gt;-->
              <!--                  <v-icon small class="mr-2"> mdi-eye </v-icon>-->
              <!--                </v-btn>-->
              <!--                <v-btn color="lighten-2" text @click="editPage(item.id)">-->
              <!--                  <v-icon small class="mr-2"> mdi-pencil </v-icon>-->
