<template>
  <v-container>
    <v-row>
      <span class="text-h5">ຈ່າຍລ່ວງໜ້າ</span>
    </v-row>
    <v-row>
      <v-col>
        <v-autocomplete
...
export default {
  ...
  data() {
    return {
      ...
      billingListHeader: [
        ...
        { text: 'ປະເພດລູກຄ້າ', value: 'custom_type', width: '100px' },
  ...
  methods: {
    ...
    fetchData(page = 1) {
      ...
      this.$axios
        .get('v2/report-billing-future-invoice', {
