...
<script>
import HomeCollection from "@views/report/TabCollectionTab/homeCollectionEvent";
// import CompanyCollection from "@views/report/TabCollectionTab/homeCollectionEvent";
import collection from "@views/report/TabCollectionTab/collectionEvent";
export default {
  title() {
